...
class EmailLoginTest(IntegrationTest, StaticLiveServerTestCase):
    ...
    def test_nonexistent_email(self, mock: mock.Mock) -> None:
        self.submit_form(
            "login",
            "input_id_login",
            send_form_keys={"id_email": "nonexistentemail@nonexistentdomain.com"},
        )
    ...
    def test_existingemail_ok(self, mock: mock.Mock) -> None:
        self.submit_form(
            "login",
            "input_id_login",
            send_form_keys={"id_email": "AnnaFreytag@dayrep.com"},
        )
        mock.assert_called()
        self.assert_url_equal("token_sent")
    ...
    def test_magiclogin(self):
        ...
        self.load_live_url(
            "email_login",
            url_get_params={"token": token},
            url_reverse_get_params={"next": "portal"},
        )
