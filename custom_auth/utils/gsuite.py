...
def _gsuite_userinfo(
    alumni: Alumni, email: Optional[str] = None, password: Optional[str] = None
) -> Dict[str, Any]:
    userInfo = {
...
def create_user(
    alumni: Alumni, email: str, password: str, service: Optional[Resource] = None
) -> str:
