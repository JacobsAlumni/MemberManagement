...
class StripeFrontendTestMixin(IntegrationTestBase):
    ...
    def submit_cancel(self, next_selector: Optional[str] = None) -> None:
        ...
        self.find_element(next_selector or self.__class__.find_element_selector)

    def submit_card_details(
        self,
        cardnumber: str = "4242 4242 4242 4242",
        exp_date: str = "12/50",
        cvc: str = "123",
        postal: str = "12345",
    ...
    def submit_sepa_details(
        self,
        iban: str = "DE89370400440532013000",
        name: str = "Anna Freytag",
        next_selector: Optional[str] = None,
    ) -> None:
        ...
        self.selenium.execute_script(
            "document.querySelector('#iban-element').scrollIntoView();"
        )
