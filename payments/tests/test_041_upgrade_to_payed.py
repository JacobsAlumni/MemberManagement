...
MOCKED_TIME = datetime(2020, 2, 4, 15, 52, 27, 62000, tzinfo=timezone.utc)
...
class UpgradeTestBase(StripeFrontendTestMixin):
    ...
    def _assert_subscription_equal(
        self,
        instance: SubscriptionInformation,
    ...
    def _assert_select_redirect_payment(self) -> None:
        ...
        self.assert_url_equal(
            "setup_subscription",
            "Check that the user is directed to enter payment details",
        )
    ...
    def test_upgrade_card_ok(self, cmock: mock.Mock, umock: mock.Mock) -> None:
        ...
        subscription = self.user.alumni.subscription
        self.assertEqual(self.user.alumni.membership.tier, self.__class__.target_tier)
        self._assert_subscription_equal(
            subscription,
            tier=self.__class__.target_tier,
    ...
    def test_upgrade_card_error_update_method(
    ...
    def test_upgrade_card_error_create_subscription(
        self, cmock: mock.Mock, umock: mock.Mock
    ) -> None:
        self.mark_skippable()
    ...
    def test_upgrade_sepa_error_update_method(
        self, cmock: mock.Mock, umock: mock.Mock
    ) -> None:
        self.mark_skippable()
    ...
    def test_upgrade_sepa_error_create_subscription(
        self, cmock: mock.Mock, umock: mock.Mock
    ) -> None:
        self.mark_skippable()
...
class ContributorUpgradeTest(
    UpgradeTestBase, IntegrationTest, StaticLiveServerTestCase
):
