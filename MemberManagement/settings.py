...
STRIPE_SECRET_KEY = "sk_test_6G2RAl6CEHIdjOrLc5ulOB8J" or os.environ.get("STRIPE_SECRET_KEY")
STRIPE_PUBLISHABLE_KEY = "pk_test_0ljYtCT6Wb27hvSgVxZ0Ztn4" or os.environ.get("STRIPE_PUBLISHABLE_KEY")
