...
class AccessTest(IntegrationTest, StaticLiveServerTestCase):
    ...
    def test_none(self) -> None:
        ...
        for url in SETUP_PROTECTED_URLS:
            if url in ['root', 'register', 'root_register']:
                continue
            self.assert_url_follow(url, 'login', '{} is protected by login'.format(url),new_url_reverse_get_params={'next': url})
    ...
    def test_setup_address(self) -> None:
        ...
        for url in SETUP_PROTECTED_URLS:
            self.assert_url_follow(url, 'setup_address', '{} is protected by setup'.format(url))
    ...
    def test_setup_social(self) -> None:
        ...
        for url in SETUP_PROTECTED_URLS:
            self.assert_url_follow(url, 'setup_social', '{} is protected by setup'.format(url))
    ...
    def test_setup_jacobs(self) -> None:
        ...
        for url in SETUP_PROTECTED_URLS:
            self.assert_url_follow(url, 'setup_jacobs', '{} is protected by setup'.format(url))
    ...
    def test_setup_job(self) -> None:
        ...
        for url in SETUP_PROTECTED_URLS:
            self.assert_url_follow(url, 'setup_job', '{} is protected by setup'.format(url))
    ...
    def test_setup_skills(self) -> None:
        ...
        for url in SETUP_PROTECTED_URLS:
            self.assert_url_follow(url, 'setup_skills', '{} is protected by setup'.format(url))
    ...
    def test_setup_atlas(self) -> None:
        ...
        for url in SETUP_PROTECTED_URLS:
            self.assert_url_follow(url, 'setup_atlas', '{} is protected by setup'.format(url))
    ...
    def test_setup_tier(self) -> None:
        ...
        for url in SETUP_PROTECTED_URLS:
            self.assert_url_follow(url, 'setup_membership', '{} is protected by setup'.format(url))
    ...
    def test_setup_completed(self) -> None:
        ...
        for url in PORTAL_SETUP_URLS:
            self.assert_url_follow(url, 'portal', '{} is not allowed after setup'.format(url))
