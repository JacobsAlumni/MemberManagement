# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-27 09:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('middleName', models.CharField(blank=True, help_text='Your middle names (optional)', max_length=255, null=True)),
                ('lastName', models.CharField(help_text='Your last name', max_length=255)),
                ('email', models.EmailField(help_text='Your private email address', max_length=254)),
                ...
                ('nationality', django_countries.fields.CountryField(help_text='Your nationality', max_length=746, multiple=True)),
                ('category', alumni.fields.AlumniCategoryField(choices=[('re', 'Alumni (Former Student)'), ('fa', 'Faculty'), ('st', 'Staff'), ('hf', 'Host Family'), ('fr', 'Friend Of The Association')], default='re', max_length=2)),
        ...
        migrations.AddField(
            model_name='address',
            name='member',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='alumni.Alumni'),
        ),
    ]
