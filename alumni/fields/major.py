...
class MajorField(CustomTextChoiceField):
    ...
    CHOICES = (
        (APPLIED_COMPUTATIONAL_MATHEMATICS, "Applied Computational Mathematics (ACM)"),
        ...
        (COMPARATIVE_POLITICS_AND_SOCIOLOGY, "Comparative PolitIcs and Sociology"),
        ...
        (GLOBAL_ECONOMICS_AND_MANAGEMENT, "Global Economics and Management (GEM)"),
        (
        ...
        (
            INTERNATIONAL_RELATIONS_GLOBAL_GOVERNANCE_AND_SOCIAL_THEORY,
        ...
        (INTERNATIONAL_HISTORY_AND_POLITICS, "International History and Politics"),
        (
        ...
        (LIFE_COURSE_AND_LIFESPAN_DYNAMICS, "Life-Course and Lifespan Dynamics"),
        ...
        (VISUAL_COMMUNICATION_AND_EXPERTISE, "Visual Communication and Expertise"),
        (
