...
EXPECT_EXPORT = [
    ...
    ['profile__date_joined', datetime.datetime(2020, 2, 4, 15, 43, 14, 821000), datetime.datetime(2020, 2, 4, 15, 39, 25, 162000), datetime.datetime(2020, 2, 4, 15, 34, 20, 250000), datetime.datetime(2020, 2, 4, 15, 30, 7, 400000), datetime.datetime(2020, 2, 4, 15, 23, 51, 168000), datetime.datetime(2020, 2, 4, 15, 19, 32, 680000), datetime.datetime(2020, 2, 4, 15, 16, 19, 631000), datetime.datetime(2020, 2, 4, 15, 11, 48, 8000), datetime.datetime(2020, 2, 4, 14, 55, 16, 898000), datetime.datetime(2019, 9, 19, 16, 16, 31, 22000)],
    ['profile__last_login', datetime.datetime(2020, 2, 4, 15, 43, 14, 838000), datetime.datetime(2020, 2, 4, 15, 39, 25, 179000), datetime.datetime(2020, 2, 4, 15, 34, 20, 265000), datetime.datetime(2020, 2, 4, 15, 30, 7, 416000), datetime.datetime(2020, 2, 4, 15, 23, 51, 179000), datetime.datetime(2020, 2, 4, 15, 19, 32, 694000), datetime.datetime(2020, 2, 4, 15, 16, 19, 649000), datetime.datetime(2020, 2, 4, 15, 11, 48, 24000), datetime.datetime(2020, 2, 4, 14, 55, 16, 909000), datetime.datetime(2020, 2, 4, 15, 59, 8, 965000)],
    ...
    ['approval__time', datetime.datetime(2020, 2, 4, 16, 0, 4), datetime.datetime(2020, 2, 4, 16, 0, 30), datetime.datetime(2020, 2, 4, 16, 0, 53), datetime.datetime(2020, 2, 4, 16, 1, 11), datetime.datetime(2020, 2, 4, 16, 1, 31), datetime.datetime(2020, 2, 4, 16, 1, 55), datetime.datetime(2020, 2, 4, 16, 2, 4), datetime.datetime(2020, 2, 4, 16, 2, 29), datetime.datetime(2020, 2, 4, 16, 2, 44), datetime.datetime(2020, 2, 4, 16, 3, 1)],
