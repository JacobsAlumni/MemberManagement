...
class AdminTest(IntegrationTest, StaticLiveServerTestCase):
    ...
    def _select_filter(self, name: str, title: str) -> None:
        ...
        summary = self.selenium.find_element(
            By.XPATH,
            '//*[@id="changelist-filter"]/details/summary[text()="By ' + name + '"]',
        )
    ...
    def test_view(self):
        ...
        # all the results
        self.load_live_url(
            "admin:alumni_alumni_changelist",
            selector=".app-alumni.model-alumni.change-list",
        )
