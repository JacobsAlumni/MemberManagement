...
class StarterTest(IntegrationTest, StaticLiveServerTestCase):
    ...
    def test_setup_starter_elements(self):
        ...
        self.assertTrue(self.selenium.find_element_by_id('id_starterReason').is_displayed())
        self.assertTrue(self.selenium.find_element_by_id('description-st').is_displayed())
        self.assertFalse(self.selenium.find_element_by_id('description-co').is_displayed())
