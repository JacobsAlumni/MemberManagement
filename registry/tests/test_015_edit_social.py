...
class EditSocialTest(IntegrationTest, StaticLiveServerTestCase):
    ...
    def test_edit_complete(self) -> None:
        ...
        social = self.user.alumni.social
        self.assertEqual(social.facebook, "https://facebook.com/freytag")
        self.assertEqual(social.linkedin, "https://www.linkedin.com/in/freytag-1234578")
        self.assertEqual(social.twitter, "https://twitter.com/freytag")
        self.assertEqual(social.instagram, "https://instagram.com/freytag")
