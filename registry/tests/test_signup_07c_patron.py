...
class PatronTest(IntegrationTest, StaticLiveServerTestCase):
    ...
    def test_setup_patron(self, mocked):
        ...
        self.assertEqual(membership.tier, TierField.PATRON)
    ...
    def test_setup_patron_fail(self, mocked):
