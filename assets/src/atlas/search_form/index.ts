...
// if we are in test mode, we make sure that 'advancedTable' is always visible
// this looks terrible, but will work
if(window.jsTestModeFlag) {
    advancedTable.parentElement!.removeChild(advancedTable);
    searchForm.appendChild(advancedTable);
}
